...
@RoutePage()
class MinesweeperLevelsScreen extends StatefulWidget {
  final LevelDifficult difficult;

  const MinesweeperLevelsScreen({super.key, required this.difficult});

  @override
  State<MinesweeperLevelsScreen> createState() => _MinesweeperLevelsScreenState();
}

class _MinesweeperLevelsScreenState extends State<MinesweeperLevelsScreen> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Spacer(),
                BlocProvider(
                  create: (context) => MinesweeperLevelsBloc(
                      GetIt.I<MinesweeperLevelsRepository>())
                    ..add(
                        GetMinesweeperLevelsEvent(difficult: widget.difficult)),
                  child:
                  BlocConsumer<MinesweeperLevelsBloc, MinesweeperLevelsState>(
                    listener: (context, state) {},
                    builder: (context, state) {
                      if (state is LoadedMinesweeperLevelsState) {
                        return Container(
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  ...
                                  if (storage.hearts > 0) {
                                    ...
                                    context.router.push(MinesweeperGameRoute(level: state.levels[index]));
                                  } else {
